...
const NavBar = () => {
    ...
    const allMenus = [
        ...
        { name: "News", link: latestSlug ? `/news/${latestSlug}` : "#" }, // Lien dynamique pour "news"
    ...
    if (loading) {
        return (
            <header className="fixed top-0 w-full text-white z-50 bg-black transition-all duration-300 ease-in-out">
